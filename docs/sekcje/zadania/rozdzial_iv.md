---
title: "Zadania - Rozdział 4"
description: "Solucja do Gothic II: New Balance — Zadania - Rozdział 4. Przebieg zadań, wybory i wskazówki."
...
## Smocze jajo dla Neorasa {#smocze-jajo-dla-neorasa}
...
## Próba Ragnara {#proba-ragnara}

Zadanie dostępne jeżeli wykonaliśmy zadanie [Asystent Neorasa](/solucja/rozdzial-ii/#asystent-neorasa). Ragnar prosi byśmy przynieśli mu runę ognisty pocisk. Znaleźliśmy ją podczas robienia wątku głównego w skrzyni na farmie Sekoba.

## Tajemnica starej księgi {#tajemnica-starej-ksiegi}
...
## Wiadomości dla Vatrasa {#wiadomosci-dla-vatrasa}
...
### Orkowie w dolinie {#orkowie-w-dolinie}
...
### Orkowi przywódcy {#orkowi-przywodcy}
