---
title: "Zadania domyślnie wyłączone"
description: "Solucja do Gothic II: New Balance — Zadania domyślnie wyłączone. Przebieg zadań, wybory i wskazówki."
slug: /solucja/wylaczone/
---

## Opiekunowie {#opiekunowie}

Zadanie zaczyna się niezależnie od tego, czy przyjęliśmy ofertę Dagotha na początku gry. Po zabiciu smoka ożywieńca na Irdorath pojawia się Dagoth. Okazuje się, że opiekunowie nas zdradzili. Dagoth znika, a my musimy pokonać cztery demony. Gadamy z Pyrokarem w klasztorze i wykonujemy zadanie Dziwne rzeczy, po czym znów gadamy z Pyrokarem.
...
### Ścieżka wojownika {#sciezka-wojownika}

   Musimy wykonać miecz z czarnej rudy. Netbek wysyła nas do Darriona, u którego wybieramy, jaki miecz chcemy zrobić. 1H to pięć kawałków czarnej rudy, natomiast 2H to dziesięć. Darrion powie, że orkowie mogą coś wiedzieć o czarnej rudzie – gadamy z Ur-Thrallem. Kiedy mamy już składniki i wybraliśmy u Darriona miecz, kujemy go w kuźni.

### Ścieżka maga {#sciezka-maga}
...
## Adept opiekunów {#adept-opiekunow}
...
2. Morius - Pojawia się przed Wieżą Xardasa po ukończeniu zadania “Serce Luciana”
...
## Prezent Ofiarny {#prezent-ofiarny}
...
## Mądrość Opiekunów {#madrosc-opiekunow}
...
## Rytuał ognia (Rozdział 3) {#rytual-ognia-rozdzial-3}
...
## Artefakt Hadesu (Rozdział 3) {#artefakt-hadesu-rozdzial-3}
...
![Kamienny portal w zadaniu Artefakt Hadesu](../../ilustracje/18-zleca-demos.png)
...
## Błagania śmierci (Rozdział 3) {#blagania-smierci-rozdzial-3}
...
## Pielgrzym (Rozdział 4) {#pielgrzym-rozdzial-4}
...
## Pierścień Narusa (Rozdział 4) {#pierscien-narusa-rozdzial-4}
...
## Duch wody (Rozdział 4) {#duch-wody-rozdzial-4}
...
![Obelisk przy drewnianej chacie w śnieżnej dolinie](../../ilustracje/19-zleca-vakon.png)

## Próba wiary {#proba-wiary}
...
1. **Użyć sfer do stworzenia Krzyża żywiołów** – potrzebne do zabicia S'enyaka w zadaniu „Artefakty Starożytności”. Mówimy o tym Stonnosowi, który akceptuje nasz wybór.
...
### Bonusy dla maga: {#bonusy-dla-maga}
...
### Bonusy dla wojownika: {#bonusy-dla-wojownika}
...
## Kłopotliwy strażnik {#klopotliwy-straznik}
...
## Atak cieniostwora {#atak-cieniostwora}
...
## Błąd Lorda Andre {#blad-lorda-andre}
...
## Poszukiwania nowicjusza {#poszukiwania-nowicjusza}
...
## Szybki sposób na zarobek {#szybki-sposob-na-zarobek}
...
3. **Ganz** – straszymy go, że wydamy go Pyrokarowi, jeśli nie zerwie kontaktu z sędzią. Pada martwy na naszych oczach. Informujemy o tym Laresa. Następnie udajemy się do Pyrokara, by dowiedzieć się szczegółów śmierci Ganza i trucizny, która go zabiła.
...
## Przebaczenie dla zdrajcy {#przebaczenie-dla-zdrajcy}
...
## Zaginiony paladyn {#zaginiony-paladyn}
...
## Szantażysta Wodnego Kręgu {#szantazysta-wodnego-kregu}
...
## Zapomniane wspomnienia Loi {#zapomniane-wspomnienia-loi}
...
## Nekromanta w Khorinis {#nekromanta-w-khorinis}
...
### Wersja I (jeśli przeczytaliśmy notatkę ze skrzyni w jaskini obok Marduka) {#wersja-i-jesli-przeczytalismy-notatke-ze-skrzyni-w-jaskini-obok-marduka}

Idziemy do Ulfa, naciskamy na niego, a ten przekazuje nam wiadomość. Spotykamy się z nekromantą na cmentarzu.

### Wersja II (jeśli nie czytaliśmy notatki) {#wersja-ii-jesli-nie-czytalismy-notatki}
...
## Poszukiwania reliktów {#poszukiwania-reliktow}
...
## Facet bez dziury chodzi ponury {#facet-bez-dziury-chodzi-ponury}
...
Udajemy się do Grega — ten mówi, że wysłał Brandicka na bagna, by szpiegował bandytów. Brandick siedzi na skale nad kamieniem teleportacyjnym. Wchodzimy po drabinie, rozmawiamy z nim, a następnie wracamy do Gritty.

## Szczęśliwa para {#szczesliwa-para}
...
## Przeklęta dusza {#przekleta-dusza}
...
## Magiczne zbawienie {#magiczne-zbawienie}
...
## Cień w potrzebie {#cien-w-potrzebie}
...
![Wejście do świątyni na pustyni](../../ilustracje/20-zleca-vatras.png)
...
## Dziwne odgłosy w świątyni {#dziwne-odglosy-w-swiatyni}
...
## Oczyść teleporty z nieumarłych {#oczysc-teleporty-z-nieumarlych}

**Zleca: Saturas**

Mamy oczyścić teleporty po obu stronach, pozbywając się nieumarłych, którzy je zajmują.

## Główny kapłan budowniczych {#glowny-kaplan-budowniczych}

**Zleca: Rademes**

Zadanie daje Rademes. Mamy zabić Khardimona, który znajduje się w bibliotece w kanionie. Zakładamy koronę Adanosa, zabijamy Khardimona i wracamy do Rademesa.
...
## Kapitan statku wojennego orków {#kapitan-statku-wojennego-orkow}
...
## Zemsta na Sylvio {#zemsta-na-sylvio}
...
### Niezwykłe rośliny {#niezwykle-rosliny}
...
### Gdzie jest moje złoto? {#gdzie-jest-moje-zloto}
...
### Zebranie załogi {#zebranie-zalogi}
...
## Zadania - Rozdział 7 {#zadania-rozdzial-7}

### Wojna z orkami {#wojna-z-orkami}

Jak tylko wrócimy z zapomnianej wyspy do Khorinis w naszej kajucie pojawi się Pyrokar. Dowiadujemy się, że miasto padło, a pozostałe miejsca na wyspie są oblegane. Da nam kilka run i każe udać się do Lorda Hagena. Robimy zadanie Pułapka, a następnie udajemy się do fortu Azgan i gadamy z Lordem Hagenem, który teraz się tam przeniósł z pozostałymi paladynami. Mamy zbadać sytuację paladynów w GD. W tym celu robimy zadanie Paladyni w Górniczej Dolinie i wracamy do Hagena zdać relację. Teraz mamy zebrać armię do walki z orkami, a będą to:

- Magowie Ognia
- Myśliwi (Po zadaniu Zbroje dla myśliwych)
- Magowie Wody (Po zadaniu Rytuał oświecenia)
- Piraci (Po zadaniu Warunek Piratów)
- Najemnicy (Po zadaniu Broń z rudy dla najemników)
- Obóz Bractwa (Po zadaniu Przewaga szybkości)
- Diego i Cavalorn (Po zadaniach Niezawodni ludzie i Pomoc dla Cavalorna)
...
## Zadania na zbieranie armii do wojny z orkami {#zadania-na-zbieranie-armii-do-wojny-z-orkami}

### Zbroje dla myśliwych {#zbroje-dla-mysliwych}
...
### Przewaga szybkości {#przewaga-szybkosci}
...
### Broń z rudy dla najemników {#bron-z-rudy-dla-najemnikow}
...
### Pomoc dla Cavalorna {#pomoc-dla-cavalorna}
...
### Potężni patroni orków {#potezni-patroni-orkow}

Po zebraniu armii na farmie Onara przed bitwą Lee mówi nam, że na orkach ciąży jakaś magia, przez co są nieśmiertelni. Idziemy do Pyrokara, a następnie do Netbeka, czekamy dzień i Netbek powie nam o stworzeniach żywiołów.

:::info Informacja

Golemy pojawią się dopiero po zabiciu Śniącego.
...
### Wola Beliara {#wola-beliara}

Beliar da nam swoją moc jak zabijemy Ur-Thralla. Zabijamy wodza orków, a potem modlimy się do kapliczki Beliara.

### Wola Innosa {#wola-innosa}

Innos da nam swoją moc jak zabijemy Kreola. Do walki z nim dochodzi po pokonaniu Śniącego. Należy wybrać opcję, że nie oddasz mu serca podczas dialogu. Po zabiciu Kreola modlimy się do kapliczki Innosa.

## Khorinis Cz. 2 {#khorinis-cz-2}
...
### Wiadomość dla króla {#wiadomosc-dla-krola}
...
### Wiadomość o niebezpieczeństwie {#wiadomosc-o-niebezpieczenstwie}
...
### Warunek piratów {#warunek-piratow}
...
### Rytuał oświecenia {#rytual-oswiecenia}
...
### Paladyni w Górniczej Dolinie {#paladyni-w-gorniczej-dolinie}

Lord Hagen prosi nas, byśmy udali się do Górniczej Doliny i zbadali sytuację paladynów. Idziemy do GD, schodzimy w dół przełęczy i spotykamy grupę paladynów Nathana. Gadamy z Nathanem i okazuje się, że zamek padł.
...
### Szturm na zamek {#szturm-na-zamek}
...
### Zlecenie Hag-Tara {#zlecenie-hag-tara}
...
### Śmiertelny pojedynek {#smiertelny-pojedynek}

Po wybraniu dialogu ze złotem, mamy stoczyć pojedynek z Hag-Tarem w leżu ognistego smoka. Po pokonaniu orka poprosi nas, abyśmy milczeli o jego porażce. Zgadzamy się, a w zamian Hag-Tar uwolni paladynów i da nam orkową miksturę.

### Przywódca orków {#przywodca-orkow}
