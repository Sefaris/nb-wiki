---
title: "Zadania poboczne - dostępne od początku gry"
description: "Solucja do Gothic II: New Balance — Zadania poboczne - dostępne od początku gry. Przebieg zadań, wybory i wskazówki."
...
## Żywy lub Martwy {#zywy-lub-martwy}
__Zleca: Notatki z tablicy ogłoszeń w koszarach__

![Ilustracja: Żywy lub Martwy](../../ilustracje/17-zywy-lub-martwy.png)
...
Mając Mora Ulartu możemy ukraść duszę demona by następnie uwięzić ją w szponie Beliara ulepszając go, musimy jednak wtedy pokonać demona w sposób konwencjonalny. Zdobytą duszę można również oddać Beliarowi w zamian za HP jeżeli zniszczyliśmy szpon.

Zabicie Senyaka przy pomocy krzyża żywiołów niszczy jego duszę sprawiając, że nie możemy jej ukraść. Oznacza to więc wybór pomiędzy łatwą walką bez nagrody w postaci duszy demona lub lepszą nagrodą za trudniejszą walkę i wysiłek wynikający ze zdobywania Mora Ulartu.
...
Wracamy do Xardasa i mówimy, że mamy amulet. Teraz udajemy się do posągu Beliara i próbujemy wymienić amulet na Mora Ulartu. Szansa na otrzymanie umiejętności zależna jest od naszej karmy i gildii. Im więcej karmy Beliara, tym lepiej. Po zdobyciu nowej umiejętności wracamy do Xardasa/Kreola/Ash'Tara (powrót do danego NPC zależny jest od postępu w fabule, sprawdź swój dziennik).

## Wątek główny podstawki G2 1-6 rozdział (Streszczenie) {#watek-glowny-podstawki-g2-1-6-rozdzial-streszczenie}
