---
title: "Orkowie"
description: "Solucja do Gothic II: New Balance — Orkowie. Przebieg zadań, wybory i wskazówki."
slug: /watki/orkowie/
---
...
### W poniższym filmiku pokazane jest jak krok po kroku zdobyć Ulu-Mulu: {#w-ponizszym-filmiku-pokazane-jest-jak-krok-po-kroku-zdobyc-ulu-mulu}

<Video id="CM_DkDBpQEM" title="Jak zdobyć Ulu-Mulu" />

## Najemnik orków {#najemnik-orkow}
...
## Trofeum dla Farroka {#trofeum-dla-farroka}
...
## Polowanie na Muritana {#polowanie-na-muritana}
...
## Wiadomość Ur karrasa {#wiadomosc-ur-karrasa}

Ur-Karras daje nam list, który mamy zanieść liderowi Klanu Wysokiej Skały (zdjęcie)
![Ilustracja: Wiadomość Ur karrasa](../../ilustracje/23-wiadomosc-ur-karrasa.png)
...
## Składowisko Paladynów {#skladowisko-paladynow}
...
![Ilustracja: Składowisko Paladynów](../../ilustracje/24-skladowisko-paladynow.png)

## Trudny wybór {#trudny-wybor}
...
## Morr Dar (orkowa arena) {#morr-dar-orkowa-arena}
...
## Księga dla Hush-Nara {#ksiega-dla-hush-nara}
...
![Ilustracja: Księga dla Hush-Nara](../../ilustracje/25-ksiega-dla-hush-nara.png)

## Sanktuarium orków {#sanktuarium-orkow}
...
<TabItem value="sposob-ulatwiony" label="sposób ułatwiony">
...
<TabItem value="maxowanie-expa" label="maxowanie expa">
...
## Miecz dla wodza {#miecz-dla-wodza}
...
## Stary miecz Harta {#stary-miecz-harta}
...
## Szacunek Tag-Nora {#szacunek-tag-nora}
...
## Kusza wielkiego łowcy {#kusza-wielkiego-lowcy}
...
## Wątek orków - Orkowa kopalnia {#watek-orkow-orkowa-kopalnia}

Aby Ur-Thrall wpuścił nas do orkowej kopalni musimy spełnić kilka wymagań:

- Zabić demona na bagnach w zadaniu [Mroczne Rytuały](/watki/orkowie/#mroczne-rytualy)
- W zadaniu [Zaginieni bez wieści](/solucja/rozdzial-ii/#zaginieni-bez-wiesci) porozmawiać z Jerganem i Talbinem, aż Garond wyśle nas na poszukiwania Wenzela pośród orków.
...
### ZADANIA W KOPALNI ORKÓW {#zadania-w-kopalni-orkow}
...
### Dolny poziom kopalni {#dolny-poziom-kopalni}
...
### Portal w kopalni orków {#portal-w-kopalni-orkow}
...
### Klucz do orkowego magazynu {#klucz-do-orkowego-magazynu}
...
### Nowy kilof dla Elka {#nowy-kilof-dla-elka}
...
### Stara kuźnia {#stara-kuznia}

Hildur prosi nas o przyniesienie 10 kawałków węgla, więc mu je oddajemy.

### Odwrócić uwagę Dobar-Shaka {#odwrocic-uwage-dobar-shaka}
...
### Wieści dla ojca {#wiesci-dla-ojca}

Morrigan prosi nas o odnalezienie ojca Carla w Khorinis. Idziemy do kowala Carla po czym wracamy do Morrigana.

### Dzienna norma rudy {#dzienna-norma-rudy}

Clovis prosi nas o przyniesienie 20 kawałków rudy żelaza, które możemy wykopać w okolicy. W zamian daje 30 bryłek złota, czyli akurat tyle ile potrzebujemy dla [Chciwego orka](/watki/orkowie/#chciwy-ork).

### Zapomniane wspomnienia {#zapomniane-wspomnienia}
...
### Odwrócić uwagę strażnika {#odwrocic-uwage-straznika}
...
![Ilustracja: Duchy przeszłości](../../ilustracje/26-duchy-przeszlosci.png)![Ilustracja: Duchy przeszłości](../../ilustracje/27-duchy-przeszlosci.png)\
...
## Wątek orków - Dolina Cieni {#watek-orkow-dolina-cieni}
...
![Ilustracja: Wątek orków - Dolina Cieni](../../ilustracje/28-watek-orkow-dolina-cieni.png)\

### Zemsta Ur-Thralla {#zemsta-ur-thralla}
...
![Ilustracja: Zemsta Ur-Thralla](../../ilustracje/29-zemsta-ur-thralla.png)\
...
![Ilustracja: Zemsta Ur-Thralla](../../ilustracje/30-zemsta-ur-thralla.png)
...
### Ludzie w dolinie {#ludzie-w-dolinie}
