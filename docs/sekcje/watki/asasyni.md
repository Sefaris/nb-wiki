---
title: "Wątek Asasynów"
description: "Solucja do Gothic II: New Balance — Wątek Asasynów. Przebieg zadań, wybory i wskazówki."
slug: /watki/asasyni/
---

## Zaginieni nowicjusze {#zaginieni-nowicjusze}
...
Darrion powie nam, że miecz pochodzi z Varantu, więc wykonujemy zadanie [Broń dla Gonzalesa](/solucja/rozdzial-i/#bron-dla-gonzalesa), Gonzales siedzi w karczmie portowej lub w burdelu. Pokazujemy mu miecz i dowiadujemy się, że za porwaniami stoi Bractwo Masjafu. Wracamy do Namiba, a ten wysyła nas do Gor na Totha w celu wysłania strażników do obozu Balama, gdyż właśnie ten obóz może zostać napadnięty. Gadamy z Gor na Tothem po czym udajemy się do obozu Balama.

Teraz wykonujemy kilka zadań dla Balama i strażnika Tiraxa:

## Bagienne ziele dla Balama {#bagienne-ziele-dla-balama}

Balam prosi nas, abyśmy przynieśli mu 10 sztuk bagiennego ziela. Respi się ono wokół jeziora, więc zbieramy i oddajemy.

## Nocne hałasy {#nocne-halasy}
...
## Jedzenie dla zbieraczy {#jedzenie-dla-zbieraczy}
...
## Mentor dla straży {#mentor-dla-strazy}
...
### Wiadomości Osaira {#wiadomosci-osaira}
...
### Stado czarnych zębaczy {#stado-czarnych-zebaczy}
...
### Spisek niewolników {#spisek-niewolnikow}
...
### Śmiertelne polowanie {#smiertelne-polowanie}
...
### Nieproszeni goście {#nieproszeni-goscie}
...
### Intrygi bractwa Masjafu {#intrygi-bractwa-masjafu}
...
## Wątek asasynów Masjaf Cz. 2 {#watek-asasynow-masjaf-cz-2}

### Księżycowe ostrza {#ksiezycowe-ostrza}

Tiamant powie nam, że Osair ma recepturę na wykucie księżycowych ostrzy. Idziemy do Osaira i mamy dwie opcje aby uzyskać recepturę: płacimy 20 000 złota albo wykonujemy zadanie [Wierni ludzie](/watki/asasyni/#wierni-ludzie). W każdym razie uzyskujemy recepturę, czytamy ją i wykuwamy miecze.\
...
### Kopalnia złota {#kopalnia-zlota}

Osair chce dowodu na to, że w kopalni siarki jest złoto. Idziemy do kopalni na sam dół do jednej z odnóg i spotykamy Lukę, którego zabijamy (związany z zadaniem [Intrygi bractwa Masjafu](/watki/asasyni/#intrygi-bractwa-masjafu)), wykopujemy specjalny kawał złota i wracamy do Osaira.

### Odprowadź niewolników do kopalni {#odprowadz-niewolnikow-do-kopalni}

Po wykonaniu zadania [Intrygi bractwa Masjafu](/watki/asasyni/#intrygi-bractwa-masjafu) wracamy do jaskini Osaira i gadamy z Joaquinem, po czym zabieramy jego i dwóch niewolników do kopalni. Po drodze do odnogi kopalni ze złotem napotykamy gobliny i pełzacze, a dodatkowo trzeba uważać, bo nowicjusze których prowadzimy potrafią dość często spaść na dół. Gadamy z Joaquinem, że jesteśmy na miejscu i siadamy na kamiennym stołku czekając na przybycie strażników. Odsyłają nas oni do Osaira, który wynagradza nas za wykonanie zadania.

### Tryumf Nrozasa {#tryumf-nrozasa}

Osair zleca nam abyśmy udali się po truciznę do Nrozasa, ten natomiast każe nam ją wypróbować. Idziemy do Gonzalesa po instrukcję: mamy wypróbować truciznę na trollu w kotlince na prawo od Gonzalesa, więc musimy zatruć truchło ścierwojada i mamy teraz dwie opcje:
...
### Ofiara Haniara {#ofiara-haniara}

Zadanie dostępne po wykonaniu [Pojedynek prawdy](/watki/asasyni/#pojedynek-prawdy). Haniar daje nam 2000 sztuk złota i każe złożyć je w ofierze Beliarowi.
...
### Swój pośród obcych Część 2 {#swoj-posrod-obcych-czesc-2}
#### Walka {#walka}
